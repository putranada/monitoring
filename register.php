                        ...
                        <div class="p-5">
                            ...
                            <form class="user">
                                ...
                                <a href="index.php" class="btn btn-google btn-user btn-block">
                                    <i class="fab fa-google fa-fw"></i> Daftarkan Dengan Google
                                </a>
                                <a href="index.php" class="btn btn-facebook btn-user btn-block">
                                    <i class="fab fa-facebook-f fa-fw"></i> Daftarkan Dengan Facebook
                                </a>
                            </form>
                            <hr>
                            <div class="text-center">
                                <a class="small" href="forgot-password.php">Tidak ingat kata sandi?</a>
                            </div>
                            <div class="text-center">
