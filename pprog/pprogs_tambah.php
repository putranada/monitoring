...
<div class="page-header">
    <h1>Tambah Pelanggaran Program Siaran</h1>
</div>
<form method="post" action="?m=pprogs_tambah" enctype="multipart/form-data">    
    <div class="row">
        <div class="col-sm-6">
            <?php if($_POST) include'../aksi.php'?>
            <div class="form-group">
            <label for="nama_stas">Nama Stasiun</label>
            <select name="nama_stas" id="id_tivi" class="form-control" required="required">
                    <option value="">--Pilih--</option>
                    <?php
                    $nama_stas = mysqli_query($koneksi,"SELECT * FROM tb_data_tv ORDER BY nama_tv ASC");
                    while ($k = mysqli_fetch_array($nama_stas)){
                        ?>
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="text" name="progaca" value="<?=$_POST['progaca']?>"/>
            </div>
            <div class="form-group">
                <label for="passal">Pasal</label>
                <select name="passal" id="id_langgar" class="form-control" required="required">
                <option value="">-Pilih-</option>
                <?php
                    $passal = mysqli_query($koneksi,"SELECT * FROM tb_langgar ORDER BY pasal ASC");
                    while ($k = mysqli_fetch_array($passal)){
                        ?>
                        <option value="<?php echo $k["pasal"]; ?>"><?php echo $k["pasal"]; ?></option>
                    <?php
                    } 
                    ?>
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="text" name="keterangann" value="<?=$_POST['keterangann']?>"/>
                </select>
            </div>
            <div class="form-group">
                <button class="btn btn-primary"><span class="glyphicon glyphicon-save"></span> Simpan</button>
                <a class="btn btn-danger" href="plprogtv.php"><span class="glyphicon glyphicon-arrow-left"></span> Kembali</a>
            </div>        
        </div>