...
<div class="page-header">
    <h1>Pelanggaran Siaran</h1>
</div>
<div class="panel panel-default">
    <div class="panel-heading">        
        <form class="form-inline">
            <input type="hidden" name="m" value="langgar" />
            <div class="form-group">
                <input class="form-control" type="text" placeholder="Pencarian. . ." name="q" value="<?=$_GET['q']?>" />            
                <button class="btn btn-success"><span class="glyphicon glyphicon-refresh"></span> Refresh</button>            
                <a class="btn btn-primary" href="langgar_tambah.php"><span class="glyphicon glyphicon-plus"></span> Tambah</a> <a class="btn btn-primary" href="../pelanggaran/print_langgar.php"><span class="glyphicon glyphicon-plus"></span>Print</a>
            </div>
        </form>
    </div>
    <div class="table-responsive">
        ...
        $sql = "SELECT * FROM tb_langgar p WHERE namastas LIKE '%$q%' ORDER BY id_langgar";
        ...
        <tr>
            ...
            <td class="nw">
                <a class="btn btn-xs btn-warning" href="langgar_ubah.php?&ID=<?=$row->id_langgar?>"><span class="glyphicon glyphicon-edit"></span></a>
                <a class="btn btn-xs btn-danger" href="../aksi.php?act=langgar_hapus&ID=<?=$row->id_langgar?>" onclick="return confirm('Hapus data?')"><span class="glyphicon glyphicon-trash"></span></a>
            </td>
        </tr>
        <?php endforeach;    ?>
        </table>
