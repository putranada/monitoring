...
<?php
    $row = $db->get_row("SELECT * FROM tb_langgar WHERE id_langgar='$_GET[ID]'"); 
?>
<!DOCTYPE html>
<html lang="en">
...
<div class="page-header">
    <h1>Ubah Data Pelanggaran Siaran</h1>
</div>
<div class="row">
    <div class="col-sm-6">
        <?php if($_POST) include'../aksi.php'?>
        <form method="post" action="?m=langgar_ubah&ID=<?=$row->id_langgar?>" enctype="multipart/form-data">
        ...
        <div class="form-group">
                <label>BAB <span class="text-danger">*</span></label>
                <input class="form-control" type="text" name="bab" value="<?=$_POST['bab']?>"/>
            </div>
            <div class="form-group">
                <label>Judul <span class="text-danger">*</span></label>
                <input class="form-control" type="text" name="judul" value="<?=$_POST['judul']?>"/>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <a class="btn btn-danger" href="langgar.php"><span class="glyphicon glyphicon-arrow-left"></span>Kembali</a>
            </div>  
        </form>
    </div>
</div>