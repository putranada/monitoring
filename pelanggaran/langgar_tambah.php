...
<div class="page-header">
    <h1>Tambah Data Pelanggaran Siaran</h1>
</div>
<form method="post" action="?m=langgar_tambah" enctype="multipart/form-data">    
    <div class="row">
        <div class="col-sm-6">
            <?php if($_POST) include'../aksi.php'?>
            <div class="form-group">
            <label for="namastas">Nama Stasiun</label>
            <select name="namastas" id="id_tivi" class="form-control" required="required">
                    <option value="">--Pilih--</option>
                    <?php
                    $namastas = mysqli_query($koneksi,"SELECT * FROM tb_data_tv ORDER BY nama_tv ASC");
                    while ($k = mysqli_fetch_array($namastas)){
                        ?>
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="text" name="progjud" value="<?=$_POST['progjud']?>"/>
            </div>
            <div class="form-group">
