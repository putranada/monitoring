...
include '../koneksi.php';
$id = $_GET['id'];
$query_pelanggaran = "select * from pelanggaran_tv where id_pelanggaran = '$id'";
                        ...
                        <div class="col-12">
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">EDIT DATA PELANGGARAN TV</h3>
                                </div>
