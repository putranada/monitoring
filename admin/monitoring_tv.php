                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <a href="tambah-monitoring-tv.php" class="btn btn-primary"><i
...
while ($row = mysqli_fetch_assoc($result)){ ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="edit-monitoring-tv.php?id=<?php echo $row['id'];?>"
                                                            class="btn btn-success btn-xs mr-1"><i class="fa fa-edit">
                                                                Ubah</i> </a>

                                                        <a href="hapus-monitoring-tv.php?id=<?php echo $row['id'];?>"
