...
if (isset($_POST["submit"])){
    ...
    $query = "INSERT INTO pelanggaran_radio VALUES ('','$jenis_pelanggaran')";
    ...
    document.location.href = 'tambah-pelanggaran-radio.php'
    </script>
    ";
}
}
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-md-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Tambah Data Pelanggaran radio</li>
                            </ol>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="card-body">
                                        <div class="form-grup">
                                            ...
                                            <input type="text" class="form-control" id="jenis_pelanggaran"
                                                name="jenis_pelanggaran" placeholder="Jenis Pelanggaran" required>
                                        </div>
