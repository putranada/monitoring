...
include '../koneksi.php';
$id = $_GET['id'];
$query_program = "select * from program_radio where id_program = '$id'";
                        ...
                        <div class="col-12">
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">EDIT DATA PROGRAM RADIO</h3>
                                </div>
