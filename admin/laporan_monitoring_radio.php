                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                ?>
                                    <a href="laporan-monitoring-tv-print.php?tanggal_dari=<?php echo $_GET['tanggal_dari'] ?>&tanggal_sampai=<?php echo $_GET['tanggal_sampai'] ?>&id_radio=<?php echo $selected_id ?>" target="_blank" class="btn btn-sm btn-primary"><i class="fa fa-print"></i> &nbsp
                                        PRINT</a> | <a href="laporan-monitoring-tv-word.php?tanggal_dari=<?php echo $_GET['tanggal_dari'] ?>&tanggal_sampai=<?php echo $_GET['tanggal_sampai'] ?>&id_radio=<?php echo $selected_id ?>" target="_blank" class="btn btn-sm btn-primary"><i class="fa fa-print"></i> &nbsp
                                        PRINT</a><?php
                                                }
                                                    ?>
                                <div class="card-body">
