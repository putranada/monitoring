...
if (isset($_POST["submit"])) {
    ...
    $query = "INSERT INTO data_tv VALUES ('','$nama_stasiun')";
    ...
    document.location.href = 'tambah-data-tv.php'
    </script>
    ";
    }
}
                        ...
                        <div class="col-12">
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">TAMBAH DATA STASIUN</h3>
                                </div>
                                <form action="" method="post">
                                    <div class="card-body">
                                        <div class="form-grup">
                                            ...
                                            <input type="text" class="form-control" id="nama_stasiun" name="nama_stasiun" placeholder="Masukkan Nama stasiun TV" required>
                                        </div>
                                        <input type="hidden" id="id_tv" name="id_tv" value="<?php echo $_SESSION["id"]; ?>">
                                    </div>
                                    <div class="footer">
