...
<body>
    ...
    <p align="center"><b>LAPORAN STATISTIK PELANGGARAN TV</b></p>
    <?php
    $data = mysqli_query($conn, "SELECT b.isi,c.nama_program,d.nama_stasiun, COUNT(a.pasal) as jumlah_pelanggaran FROM monitoring_tv a 
         JOIN pasal b ON a.pasal = b.id
         JOIN program_tv c ON a.program = c.id_program
         JOIN data_tv d ON a.tv = d.id_tv
         GROUP BY a.pasal");
