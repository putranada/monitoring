...
<div class="panel panel-default">
    <div class="panel-heading">        
        <form class="form-inline">
            <input type="hidden" name="m" value="dat_radio" />
            <div class="form-group">
                <input class="form-control" type="text" placeholder="Pencarian. . ." name="q" value="<?=$_GET['q']?>" />            
                <button class="btn btn-success"><span class="glyphicon glyphicon-refresh"></span> Refresh</button>            
                <a class="btn btn-primary" href="data_radio.php"><span class="glyphicon glyphicon-plus"></span> Tambah</a>
            </div>
        </form>
    </div>
    <div class="table-responsive">
        ...
        $sql = "SELECT * 
                FROM tb_data_radio p
                WHERE lps_radio LIKE '%$q%' 
                ORDER BY id_radiu";
        ...
        <tr>
            ...
            <td><?=$row->lps_radio?></td>
            <td class="nw">
                <a class="btn btn-xs btn-danger" href="../aksi.php?act=dat_radio&ID=<?=$row->id_radiu?>" onclick="return confirm('Hapus data?')"><span class="glyphicon glyphicon-trash"></span></a>
            </td>
        </tr>
        <?php endforeach;    ?>
        </table>
