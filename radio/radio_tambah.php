...
<form method="post" action="?m=radio_tambah" enctype="multipart/form-data">
    <div class="row">
        <div class="col-sm-6">
            <?php if($_POST) include'../aksi.php'?>
            <div class="form-group">
                <label>Lembaga Penyiaran <span class="text-danger">*</span></label>
                <input class="form-control" type="text" name="penyiaran" value="<?=$_POST['penyiaran']?>"/>
            </div>
            <div class="form-group">
            <label for="nama_stasiun_radio">Nama Stasiun Radio</label>
            <select name="nama_stasiun_radio" id="id_radiu" class="form-control" required="required">
                    <option value="">--Pilih--</option>
                    <?php
                    $nama_stasiun_radio = mysqli_query($koneksi,"SELECT * FROM tb_data_radio ORDER BY lps_radio ASC");
                    while ($k = mysqli_fetch_array($nama_stasiun_radio)){
                        ?>
                        <option value="<?php echo $k["id_radiu"]; ?>"><?php echo $k["lps_radio"]; ?></option>
                    <?php
                    } 
                    ?>
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="text" name="frekuensi" value="<?=$_POST['frekuensi']?>"/>
            </div>
            <div class="form-group">
                <label>Program Unggulan</label>
                <input class="form-control" type="text" name="prog_unggulan" value="<?=$_POST['prog_unggulan']?>"/>
            </div>
            <div class="form-group">
                <label>Keterangan</label>
                <input class="form-control" type="text" name="pelanggaran" value="<?=$_POST['pelanggaran']?>"/>
            </div>
            <div class="form-group">
                <label>Pasal</label>
            ...
            <div class="form-group">
                ...
                <a class="btn btn-danger" href="radio.php"><span class="glyphicon glyphicon-arrow-left"></span> Kembali</a>
            </div>        
        </div>