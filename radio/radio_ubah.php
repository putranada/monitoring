...
<?php
    $row = $db->get_row("SELECT * FROM tb_radio WHERE id_radio='$_GET[ID]'"); 
?>
<!DOCTYPE html>
<html lang="en">
...
<div class="page-header">
    <h1>Ubah Data Radio</h1>
</div>
<div class="row">
    <div class="col-sm-6">
        <?php if($_POST) include'../aksi.php'?>
        <form method="post" action="?m=radio_ubah&ID=<?=$row->id_radio?>" enctype="multipart/form-data">
        <div class="form-group">
            ...
            <div class="form-group">
                <label>Nama Stasiun <span class="text-danger">*</span></label>
                <input class="form-control" type="text" name="nama_stasiun_radio" value="<?=$_POST['nama_stasiun_radio']?>"/>
            </div>
            <div class="form-group">
