...
<div class="page-header">
    <h1>Monitoring Radio</h1>
</div>
<div class="panel panel-default">
    <div class="panel-heading">        
        <form class="form-inline">
            <input type="hidden" name="m" value="radio" />
            <div class="form-group">
                <input class="form-control" type="text" placeholder="Pencarian. . ." name="q" value="<?=$_GET['q']?>" />            
                <button class="btn btn-success"><span class="glyphicon glyphicon-refresh"></span> Refresh</button>            
                <a class="btn btn-primary" href="radio_tambah.php"><span class="glyphicon glyphicon-plus"></span> Tambah</a> <a class="btn btn-primary" href="../radio/print_radio.php"><span class="glyphicon glyphicon-plus"></span>Print</a>
            </div>
        </form>
    </div>
    <div class="table-responsive">
        ...
        $sql = "SELECT *  FROM tb_radio WHERE penyiaran LIKE '%$q%' ORDER BY id_radio";
        ...
        <tr>
            <td><?=++$no?></td>
            <td><?=$row->penyiaran?></td>
            <td><?=$row->nama_stasiun_radio?></td>
            <td><?=$row->frekuensi?></td>
            <td><?=$row->prog_unggulan?></td>
            <td><?=$row->keterangan?></td>
            <td><?=$row->pasal?></td>
            <td class="nw">
                <a class="btn btn-xs btn-warning" href="radio_ubah.php?&ID=<?=$row->id_radio?>"><span class="glyphicon glyphicon-edit"></span></a>
                <a class="btn btn-xs btn-danger" href="../aksi.php?act=radio_hapus&ID=<?=$row->id_radio?>" onclick="return confirm('Hapus data?')"><span class="glyphicon glyphicon-trash"></span></a>
            </td>
        </tr>
        <?php endforeach;    ?>
        </table>
