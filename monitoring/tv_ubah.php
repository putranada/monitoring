...
<?php
    $row = $db->get_row("SELECT * FROM tb_tv WHERE id_tv='$_GET[ID]'"); 
?>
<!DOCTYPE html>
<html lang="en">
...
<div class="page-header">
    <h1>Ubah Data Monitoring TV</h1>
</div>
<div class="row">
    <div class="col-sm-6">
        <?php if($_POST) include'../aksi.php';?>
        <form method="post" action="?m=tv_ubah&ID=<?=$row->id_tv?>" enctype="multipart/form-data">
            <div class="form-group">
                <label>Hari<span class="text-danger">*</span></label>
                <input class="form-control" type="text" name="hari" value="<?=$_POST['hari']?>"/>
            </div>
            <div class="form-group">
                <label>Tanggal <span class="text-danger">*</span></label>
                <input class="form-control" type="text" name="tanggal" value="<?=$_POST['tanggal']?>"/>
            </div>
            <div class="form-group">
            <label for="nama_stasiun">Nama Stasiun</label>
            <select name="nama_stasiun" id="id_tivi" class="form-control" required="required">
                    <option value="">--Pilih--</option>
                    <?php
                    $nama_stasiun = mysqli_query($koneksi,"SELECT * FROM tb_data_tv ORDER BY nama_tv ASC");
                    while ($k = mysqli_fetch_array($nama_stasiun)){
                        ?>
                        <option value="<?php echo $k["id_tivi"]; ?>"><?php echo $k["nama_tv"]; ?></option>
                    <?php
                    } 
                    ?>
                </select>
            ...
            <div class="form-group">
                <label>Jam Tayang <span class="text-danger">*</span></label>
                <input class="form-control" type="text" name="jam_tayang" value="<?=$_POST['jam_tayang']?>"/>
            </div>
            <div class="form-group">
                <label>Program/Judul Acara <span class="text-danger">*</span></label>
                <input class="form-control" type="text" name="program" value="<?=$_POST['program']?>"/>
            </div>
            <div class="form-group">
                <label>Time Code <span class="text-danger">*</span></label>
                <input class="form-control" type="text" name="time_code" value="<?=$_POST['time_code']?>"/>
            </div>
            <div class="form-group">
                <label>Keterangan</label>
                <textarea class="form-control" type="text" name="keterangan"><?=$_POST['keterangan']?></textarea>
            </div>
            <div class="form-group">
                <label>Pasal <span class="text-danger">*</span></label>
                <input class="form-control" type="text" name="pasal" value="<?=$_POST['pasal']?>"/>
            </div>
            <div class="form-group">
                <button class="btn btn-primary"><span class="glyphicon glyphicon-save"></span>Simpan</button>
                <a class="btn btn-danger" href="tv.php"><span class="glyphicon glyphicon-arrow-left"></span>Kembali</a>
            </div>  
        </form>
    </div>
</div>