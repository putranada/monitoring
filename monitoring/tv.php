...
<div class="panel panel-default">
    <div class="panel-heading">        
        <form class="form-inline">
            ...
            <div class="form-group">
                ...
                <a class="btn btn-primary" href="tv_tambah.php"><span class="glyphicon glyphicon-plus"></span> Tambah</a> <a class="btn btn-primary" href="../monitoring/print_monitoring.php"><span class="glyphicon glyphicon-plus"></span>Print</a>
            </div>
        </form>
    </div>
    <div class="table-responsive">
        ...
        <tr>
            ...
            <td><?=$row->pasal?></td>
            <td class="nw">
                <a class="btn btn-xs btn-warning" href="tv_ubah.php?m=tv_ubah?&ID=<?=$row->id_tv?>"><span class="glyphicon glyphicon-edit"></span></a>
                <a class="btn btn-xs btn-danger" href="../aksi.php?act=tv_hapus&ID=<?=$row->id_tv?>" onclick="return confirm('Hapus data?')"><span class="glyphicon glyphicon-trash"></span></a>
            </td>
        </tr>
        <?php endforeach;    ?>
        </table>
