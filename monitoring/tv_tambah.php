...
<div class="page-header">
    <h1>Tambah Data Monitoring TV</h1>
</div>
<form method="post" action="?m=tv_tambah" enctype="multipart/form-data">    
    <div class="row">
        <div class="col-sm-6">
            ...
            <select name="nama_stasiun" id="id_tivi" class="form-control" required="required">
                    ...
                    while ($k = mysqli_fetch_array($nama_stasiun)){
                        ?>
                        <option value="<?php echo $k["nama_tv"]; ?>"><?php echo $k["nama_tv"]; ?></option>
                    <?php
                    } 
                    ?>
                </select>
