...
<div class="page-header">
    <h1>Tambah Data Program Radio</h1>
</div>
<form method="post" action="?m=progradio" enctype="multipart/form-data">
    <div class="row">
        <div class="col-sm-6">
            <?php if($_POST) include'../aksi.php'?>
            <div class="form-group">
                <label>Program Radio<span class="text-danger">*</span></label>
                <input class="form-control" type="text" name="program_radio" value="<?=$_POST['program_radio']?>"/>
            </div>
            <div class="form-group">
                <button class="btn btn-primary"><span class="glyphicon glyphicon-save"></span>Simpan</button>
                <a class="btn btn-danger" href="program_radio.php"><span class="glyphicon glyphicon-arrow-left"></span>Kembali</a>
            </div>        
        </div>