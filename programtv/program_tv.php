...
<div class="page-header">
    <h1>Tambah Data Program TV</h1>
</div>
<form method="post" action="?m=programtv" enctype="multipart/form-data">    
    <div class="row">
        <div class="col-sm-6">
            <?php if($_POST) include'../aksi.php'?>
            <div class="form-group">
                <label>Nama Program TV <span class="text-danger">*</span></label>
                <input class="form-control" type="text" name="nama_ptv" value="<?=$_POST['nama_ptv']?>"/>
            </div>
            <div class="form-group">
                <button class="btn btn-primary"><span class="glyphicon glyphicon-save"></span>Simpan</button>
                <a class="btn btn-danger" href="ptv.php"><span class="glyphicon glyphicon-arrow-left"></span>Kembali</a>
            </div>        
        </div>
